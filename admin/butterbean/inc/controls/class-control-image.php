...
class ButterBean_Control_Image extends ButterBean_Control {
	...
	public function __construct( $manager, $name, $args = array() ) {
		...
		$this->l10n = wp_parse_args(
			$this->l10n,
			array(
				'upload'      => esc_html__( 'Add image',         'ejo-testimonials' ),
				'set'         => esc_html__( 'Set as image',      'ejo-testimonials' ),
				'choose'      => esc_html__( 'Choose image',      'ejo-testimonials' ),
				'change'      => esc_html__( 'Change image',      'ejo-testimonials' ),
				'remove'      => esc_html__( 'Remove image',      'ejo-testimonials' ),
				'placeholder' => esc_html__( 'No image selected', 'ejo-testimonials' )
			)
		);
	}
