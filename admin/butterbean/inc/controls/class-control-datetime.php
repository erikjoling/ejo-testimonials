...
class ButterBean_Control_Datetime extends ButterBean_Control {
	...
	public function to_json() {
		...
		$this->json['year'] = array(
			'value' => esc_attr( $year ),
			'label' => esc_html__( 'Year', 'ejo-testimonials' ),
		...
		$this->json['month'] = array(
			...
			'label'   => esc_html__( 'Month', 'ejo-testimonials' ),
			'choices' => array(
				array(
					'num'   => '',
					'label' => ''
		...
		$this->json['day'] = array(
			...
			'label' => esc_html__( 'Day', 'ejo-testimonials' ),
		...
		$this->json['hour'] = array(
			...
			'label' => esc_html__( 'Hour', 'ejo-testimonials' ),
		...
		$this->json['minute'] = array(
			...
			'label' => esc_html__( 'Minute', 'ejo-testimonials' ),
			'attr'  => 'placeholder="00" size="2" maxlength="2" autocomplete="off"'
		);
		...
		$this->json['second'] = array(
			...
			'label' => esc_html__( 'Second', 'ejo-testimonials' ),
			'attr'  => 'placeholder="00" size="2" maxlength="2" autocomplete="off"'
		);
	}
}
